...
//Level measured on real hardware. Upstream LoopyMSE uses 0.7, which clips on
//loud multi-voice passages; the core option can restore it.
constexpr static float MIX_LEVEL = 0.62f;
